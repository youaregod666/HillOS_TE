...
local installerPath = "/HillOS installer/"
...
local function title()
	...
	centrizedText(y, 0xFFFFFF, "HillOS")
...
function require(module)
	...
	elseif package.loading[module] then
		...
		local handle, reason = temporaryFilesystemProxy.open(installerPath .. ".system/Libraries/" .. module .. ".lua", "rb")
		if handle then
			local data, chunk = ""
			repeat
