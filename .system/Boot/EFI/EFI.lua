...
local function UIRequire(module)
	...
	local title1, width, total = "HillOS TE " .. VersionThing, 1, 1
	local title, width, total = "Starting HillOS TE", 26, 14
	...
	component.invoke(GPUAddress, "set", 1, 1, title1)
...
system.BranchName_ = "dev_moonspace"
