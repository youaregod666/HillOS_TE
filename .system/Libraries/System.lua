...
--------------------------------------------------------------------------------
-- Version String
local HillOSVersion2 = "1.2.27.1"
local HillOSVersion = "1.2.27.1"
local MineOSVersion = "1.2.27.1"
local BN = "1.3"
local NeededForAppstore

-- Branch String
local BranchName = "dev_moonspace"
...
local desktopBackgroundColor = 0x336dbf
...
function system.updateDesktop()
	...
	desktopMenuMineOSItem = desktopMenu:addContextMenuItem("HillOS TE", 0x000000)
	...
	desktopMenuMineOSItem:addItem(localization.aboutSystem).onTouch = function()
		...
		local lines = {
			...
			" ",
			"This Project is based on MineOS from late 2022",
			" ",
...
function system.authorize()
	...
	if BranchName == "dev_moonspace" then
